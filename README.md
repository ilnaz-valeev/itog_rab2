...
## **Решение**
1. Вы находитесь в созданном репозитории `new_itog_rab`.
...
> ![image answer in terminal](print.png)

5. Скриншот коммитов для подтверждения.

>![Screenshot of commits](commit1.PNG)

>![Screenshot of commits](commit2.PNG)

>![Screenshot of commits](commit3.PNG)

>![Screenshot of commits](commit4.PNG)